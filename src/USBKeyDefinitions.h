...
static std::unordered_map<std::string, USBKeyDefinition> keyLookupTable = {
    ...
    {"é", USBKeyDefinition(USBKeyDefinition::UsbHidModifiers::LeftShift, 0x1f)},
    ...
    {"_", USBKeyDefinition(USBKeyDefinition::UsbHidModifiers::LeftShift, 0x25)},
    {"ç", USBKeyDefinition(USBKeyDefinition::UsbHidModifiers::LeftShift, 0x26)},
